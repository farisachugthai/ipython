...
if __name__ == '__main__':
    ...
    # Touch this file for the make target. Well fuck don't write then you're making it empty!
    with open(generated, 'r'):
        pass

    # commented out because i don't need them anymore and don't want them
    # autogenerating BS in the wrong dir
