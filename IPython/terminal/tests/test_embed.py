...
# This doesn't import the file it tests??...
from IPython.terminal.embed import EmbeddedMagics, InteractiveShellEmbed
...
def setup_module():
    global env
    env = os.environ.copy()
    os.environ.putenv("IPY_TEST_SIMPLE_PROMPT", "1")


def teardown_module():
    os.environ.unsetenv("IPY_TEST_SIMPLE_PROMPT")
