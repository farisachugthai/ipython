...
class InteractiveShellEmbed(TerminalInteractiveShell):
    ...
    def embedded_active(self):
        ...
        """
        return (self._call_location_id not in
                InteractiveShellEmbed._inactive_locations) and (
                    self._init_location_id not in
                    InteractiveShellEmbed._inactive_locations)
    ...
    def mainloop(
        ...
        if (local_ns is None or module is None
                or compile_flags is None) and self.default_user_namespaces:
